...
covering `0x0000_0000..0x07ff_ffff` (128 MiB).  The AP board wrapper must
translate the SoC's 48-bit `AP_BPI_BASE` mapping to that aperture.
...
The wrapper must implement the complete XAPP1282 mapping, including IOBUFs for
