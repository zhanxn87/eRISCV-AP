...
module ap_soc #(
  ...
  ) mem_axi [AP_AXI_MEM_INGRESS_PORTS-1:0] ();
  AXI_BUS #(
    .AXI_ADDR_WIDTH(AP_PADDR_W),
    .AXI_DATA_WIDTH(AP_AXI_DATA_W),
    .AXI_ID_WIDTH(AP_AXI_SLV_ID_W),
  ...
  logic [AP_PADDR_W-1:0] eth_apb_paddr;
  logic [31:0] eth_apb_pwdata;
  logic [3:0] eth_apb_pstrb;
  logic eth_apb_pready;
  logic [31:0] eth_apb_prdata;
  logic eth_apb_pslverr;
  logic clint_msip;
  logic clint_mtip;
  logic plic_meip;
  logic plic_seip;
  ...
  ap_ethernet_subsystem ethernet_i (
    .clk,
    .rst_n,
    .apb_psel_i(eth_apb_psel),
    .apb_penable_i(eth_apb_penable),
    .apb_pwrite_i(eth_apb_pwrite),
    .apb_paddr_i(eth_apb_paddr),
    .apb_pwdata_i(eth_apb_pwdata),
    .apb_pstrb_i(eth_apb_pstrb),
    .apb_pready_o(eth_apb_pready),
    .apb_prdata_o(eth_apb_prdata),
    .apb_pslverr_o(eth_apb_pslverr),
    .eth_rx_clk_i,
    .eth_rx_rst_n_i,
    .eth_gmii_rxd_i,
    .eth_gmii_rx_dv_i,
    ...
    .eth_gmii_tx_er_o,
    .irq_o(eth_irq),
    .mem_axi_o(mem_axi[AP_AXI_MEM_INGRESS_ETH_DMA])
  );
  ...
  ap_peripheral_subsystem peripheral_system_i (
    ...
    .meip_o(plic_meip),
    .seip_o(plic_seip),
    .eth_psel_o(eth_apb_psel),
    .eth_penable_o(eth_apb_penable),
    .eth_pwrite_o(eth_apb_pwrite),
    .eth_paddr_o(eth_apb_paddr),
    .eth_pwdata_o(eth_apb_pwdata),
    .eth_pstrb_o(eth_apb_pstrb),
    .eth_pready_i(eth_apb_pready),
